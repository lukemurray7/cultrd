...
export const mockContinueLearningPaths: LearningPathProgress[] = [
  {
    ...
    courses: ["1", "4", "macro-1", "macro-2", "micro-1", "be-1"],
    totalCourses: 6,
    totalDuration: 180,
    coursesCompleted: 2,
  ...
  },
  {
    ...
    courses: ["5", "phil-1", "phil-4", "eth-1", "phil-6"],
    totalCourses: 5,
    totalDuration: 120,
    coursesCompleted: 1,
...
export const mockExplorePaths: LearningPath[] = [
  {
    ...
    courses: ["3", "ac-1", "ac-2", "ac-3", "ac-4", "eh-1", "eh-2", "eh-3", "ah-1", "ah-2", "ah-3", "ww-1"],
    totalCourses: 12,
    totalDuration: 375,
  },
  {
    ...
    courses: ["cult-1", "cult-2", "cult-3", "cult-4", "cs-1"],
    totalCourses: 5,
    totalDuration: 200,
  },
  {
    ...
    category: "Politics",
    imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuAJwpEhNwM3-Jd0v-rVvTyRGrmCaSBIQMuWv926Bxlynio57bB_MzdUr50iFz4XeNoA3eL01ryAcylUxfVIarxCZYr2oUicaFy_VBU0QDiqGM4Z5oXrK6Z_O7zrE3D9h8f8MJ4_OL53BG4Z1HYwTmLjgXTvG398a_tExUCXRtSGJyG1nDbp12HeJ6Wcj40mEfB8yvYjcyFhc422PrQ_cqZkQUY6vjVy8Wl8oZrM6GtTKD22QEk1l8ny8cbc12v7MmB-lJjBsZCdu8nf",
    courses: ["pt-1", "pt-2", "pt-3", "pt-4", "ir-1", "ir-2", "cp-1", "cp-2"],
    totalCourses: 8,
    totalDuration: 285,
  },
];
